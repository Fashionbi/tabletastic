...
You can change the css class name from the action link, default are edit_link, destroy_link, show_link.
  Tabletastic.default_actions_link_class = {:edit => 'edit', :destroy => 'delete', :show => 'show '}

Table html option
  Tabletastic.default_table_html = {:class => 'data-list', :width => '100%'}
